...
// // const MIN_DELAY_MS = 4000;      // 4s
// // const MAX_DELAY_MS = 9000;      // 9s
// // const MAX_PER_BATCH = 40;       // máximo por campanha / execução
// // const MAX_DAILY_TOTAL = 200;    // limite diário simplificado
...
// // /**
// //  * Cria uma campanha e envia para contatos opt-in.
// //  * filters: { onlyOptIn: boolean, onlyNonGroup: boolean }
// //  */
// // async function createAndSendBroadcast({ name, message, filters = {} }) {
