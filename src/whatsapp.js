...
function waitForReady() {
  ...
  return new Promise((resolve) => { readyPromiseResolve = resolve; });
}
...
// Status para o painel e para o QR
...
client.on('message', async (msg) => {
  try {
    ...
    if (body === 'oi' || body === 'olá' || body === 'ola') {
      await msg.reply('Olá! Bem-vindo ao atendente virtual...');
    }
    // Outros comandos...
  } catch (err) {
    // Trate erros aqui
...
// // // Helper: aguarda WhatsApp client ficar pronto
// // function waitForReady() {
// //   if (isReady) return Promise.resolve();
// //   return new Promise((resolve) => { readyPromiseResolve = resolve; });
// // }
...
// // // Eventos
// // client.on('qr', (qr) => {
// //   console.log('QR code recebido. Escaneie no seu app WhatsApp.');
// //   lastQr = qr;
// //   isReady = false;
// // });
...
// // client.on('disconnected', (reason) => {
// //   console.warn('WhatsApp disconnect:', reason);
// //   isReady = false;
// // });
...
// // // Sincronizar contatos (só depois de "ready" = true)
// // async function syncContacts() {
// //   await waitForReady();
// //   const contacts = await client.getContacts();
...
// //     // Filtro exemplo ‑ ajuste: importar só contatos válidos
// //     if (c.isGroup) { skipped++; continue; }
...
// // // Exemplo de resposta automática (ajuste conforme sua lógica)
// // client.on('message', async (msg) => {
// //   try {
// //     if (!isReady) return;
// //     const body = (msg.body || '').trim().toLowerCase();
// //     if (body === 'oi' || body === 'olá' || body === 'ola') {
// //       await msg.reply('Olá! Bem-vindo ao atendente virtual da SuperTI...');
// //     }
...
// // // Exporta módulos para uso no server.js e outros
// // module.exports = {
// //   client,
// //   syncContacts,
// //   getQrStatus,
